...
<a href="{{route('admin::add_addon') }}" class="btn btn-warning " style="margin-left:800px;!important;"> Add New Addon</a>
          ...
          <div class="col-12">
           ...
           <div class="box"style="width:96%;">
              <div class="box-header with-border">
                <h3 class="box-title">Addons List</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  <div class="table-responsive">
                    <table id="example5" class="table table-bordered table-striped" style="width:100%">
                      ...
                      <tbody>
                          ...
                          <tr>
                              <td>{{ $data_sets->name }}</td>
                              <td>{{ $data_sets->price }}</td>
                              <td><img src="{{ $data_sets->image }}" class="category_image"></td>
                              ...
                              <td><a href="{{ route('admin::edit_addon',$data_sets->activity_key) }}" class="btn btn-primary">Edit</a> || <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#myModal{{ $data_sets->id }}">Delete</button></td>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content"style="margin-top: 50%;">
                                ...
                                <div class="modal-body text-center">
                                 ...
                                 <a href="{{ route('admin::del_addon',$data_sets->activity_key) }}" class="btn btn-primary">Yes</a>&nbsp;
                ...
                $.ajax({
                    ...
                    success : function(data) {
                       if(data=='true')
                       {
                        ...
                        window.location.href = "{{ route('admin::view_addon') }}";
