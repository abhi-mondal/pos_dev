<header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="index.html" class="logo">
		  <!-- logo-->
		  <div class="logo-lg">
			  <span class="light-logo"><img src="{{url('/')}}/Admintheme/assets/images/logo-dark-text.png" alt="logo"></span>
			  <span class="dark-logo"><img src="{{url('/')}}/Admintheme/assets/images/logo-light-text.png" alt="logo"></span>
		  </div>
		</a>
	</div>
    <!-- Header Navbar -->
        ...
        <ul class="nav navbar-nav">
			  ...
			  <li>
				...
				<ul class="menu sm-scrol">
				  <li><!-- start message -->
					<a href="#">
					  <div class="pull-left">
						<img src="{{url('/')}}/Admintheme/assets/images/user2-160x160.jpg" class="rounded-circle" alt="User Image">
					  </div>
				  ...
				  <li>
					<a href="#">
					  <div class="pull-left">
						<img src="{{url('/')}}/Admintheme/assets/images/user3-128x128.jpg" class="rounded-circle" alt="User Image">
					  </div>
					  <div class="mail-contnet">
						 <h4>
						  Nullam tempor
				  ...
				  <li>
					<a href="#">
					  <div class="pull-left">
						<img src="{{url('/')}}/Admintheme/assets/images/user4-128x128.jpg" class="rounded-circle" alt="User Image">
					  </div>
					  <div class="mail-contnet">
						 <h4>
						  Proin venenatis
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle p-0 text-dark hover-primary ms-md-30 ms-10" data-bs-toggle="dropdown" title="User">
				<span class="ps-30 d-md-inline-block d-none">Hello,</span> <strong class="d-md-inline-block d-none"><?php echo Auth::user()->name;?></strong><img src="{{url('/')}}/Admintheme/assets/images/avatar/avatar-11.png" class="user-image rounded-circle avatar bg-white mx-10" alt="User Image">
            </a>
